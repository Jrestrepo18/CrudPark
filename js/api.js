const BASE_URL = 'http://172.20.10.2:5127/api';
...
export const sendReminderEmail = (idMensualidad) => request(`/Mensualidades/enviar-recordatorios/${idMensualidad}`, { method: 'POST' });
